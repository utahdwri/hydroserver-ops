...
export const tileSources: ConfigTileSource[] = [
  ...
  },
  {
    ...
    type: 'base',
    source: new XYZ({
      url: 'https://discover.agrc.utah.gov/login/path/escape-monaco-pogo-solar/tiles/utah/{z}/{x}/{y}',
      attributions: 'Tiles © PLACEHOLDER',
    }),
  },
  {
    name: 'Utah Tiles — Hybrid',
    type: 'base',
    source: new XYZ({
      url: 'https://discover.agrc.utah.gov/login/path/escape-monaco-pogo-solar/tiles/hybrid_basemap/{z}/{x}/{y}',
      attributions: 'Tiles © PLACEHOLDER',
    }),
  },
  {
    name: 'Utah Tiles — Lite',
    type: 'base',
    source: new XYZ({
      url: 'https://discover.agrc.utah.gov/login/path/escape-monaco-pogo-solar/tiles/lite_basemap/{z}/{x}/{y}',
      attributions: 'Tiles © PLACEHOLDER',
    }),
  },
  {
    name: 'Utah Tiles — Overlay',
    type: 'base',
    source: new XYZ({
      url: 'https://discover.agrc.utah.gov/login/path/escape-monaco-pogo-solar/tiles/overlay_basemap/{z}/{x}/{y}',
      attributions: 'Tiles © PLACEHOLDER',
    }),
  },
  {
    name: 'Utah Tiles — Terrain',
    type: 'satellite',
    source: new XYZ({
      url: 'https://discover.agrc.utah.gov/login/path/escape-monaco-pogo-solar/tiles/terrain_basemap/{z}/{x}/{y}',
      attributions: 'Tiles © PLACEHOLDER',
    }),
  },
  {
    name: 'Utah Tiles — Google',
    type: 'base',
    source: new XYZ({
      url: 'https://discover.agrc.utah.gov/login/path/escape-monaco-pogo-solar/tiles/google/{z}/{x}/{y}',
      attributions: 'Tiles © PLACEHOLDER',
    }),
  },
  // {
